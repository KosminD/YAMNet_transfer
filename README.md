...
## Train the Model
You can train you custom model with train.py:
```shell
python train.py <data_path/> <model_name.h5>
```

## Convert TFlite model
To convert your custom model with export.py:
```shell
python export.py <yamnet_path.h5> <model_path.h5> <output_dir/>
```
## About the Model
